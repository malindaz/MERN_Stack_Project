    ...
    return ( 
        <Grid container spacing={2} sx={{backgroundColor: '#ffffff', marginBottom: '30px', display: 'block'}}>
            ...
            <Grid item xs={12} sm={6} sx={{ display:'flex'}}>
                ...
                <Input type="text" id='id' name="id" sx={{ width:'400px'}} value={id} onChange={e => setId(e.target.value) }/>
            </Grid>
            ...
            <Button
                sx={{ margin:'auto', marginBottom: '20px', backgroundColor: '#00c6e6', color: '#000000', 
                    marginLeft: '15px', marginTop: '20px', '&:hover':{ opacity:0.7, backgroundColor: '#00c6e6' }
                }}> Add
            </Button>
        </Grid>
    );
